...
#include <stddef.h>
#include "evpi_interfaces/msg/detail/mode__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  evpi_interfaces__msg__Mode__init(message_memory);
}

void Mode__rosidl_typesupport_introspection_c__Mode_fini_function(void * message_memory)
{
  evpi_interfaces__msg__Mode__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Mode__rosidl_typesupport_introspection_c__Mode_message_member_array[5] = {
  {
    "strip_id",  // name
    ...
    offsetof(evpi_interfaces__msg__Mode, strip_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evpi_interfaces__msg__Mode, mode),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evpi_interfaces__msg__Mode, red_value),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evpi_interfaces__msg__Mode, green_value),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(evpi_interfaces__msg__Mode, blue_value),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Mode__rosidl_typesupport_introspection_c__Mode_message_members = {
  ...
  "Mode",  // message name
  5,  // number of fields
  sizeof(evpi_interfaces__msg__Mode),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, evpi_interfaces, msg, Mode)() {

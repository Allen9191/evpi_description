...
#include "evpi_interfaces/msg/detail/multi_range__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_evpi_interfaces
...
using _MultiRange__ros_msg_type = evpi_interfaces__msg__MultiRange;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MultiRange__ros_msg_type * ros_message = static_cast<const _MultiRange__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MultiRange__ros_msg_type * ros_message = static_cast<_MultiRange__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_evpi_interfaces__msg__MultiRange(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MultiRange__ros_msg_type * ros_message = static_cast<const _MultiRange__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MultiRange__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_evpi_interfaces__msg__MultiRange(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_evpi_interfaces
size_t max_serialized_size_evpi_interfaces__msg__MultiRange(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_evpi_interfaces__msg__MultiRange(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MultiRange = {
  "evpi_interfaces::msg",
  "MultiRange",
...
static rosidl_message_type_support_t _MultiRange__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MultiRange,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, evpi_interfaces, msg, MultiRange)() {
  return &_MultiRange__type_support;
}
